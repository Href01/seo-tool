...
export const PT: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    authLoginTitle: 'Connexion', authSignupTitle: 'Créer un compte',
    authSub: 'Compte requis pour les projets, le suivi de position et le tableau de bord admin.',
    authTabLogin: 'Connexion', authTabSignup: 'Inscription',
    authName: 'Nom', authPassword: 'Mot de passe', authEmail: 'email@site.com',
    authSignupBtn: 'Créer le compte', authWait: 'Patiente…',
    authPwHint: '8 caractères minimum.',
  ...
  ar: {
    ...
    authLoginTitle: 'تسجيل الدخول', authSignupTitle: 'إنشاء حساب',
    authSub: 'حساب مطلوب للمشاريع وتتبّع المراكز ولوحة الإدارة.',
    authTabLogin: 'دخول', authTabSignup: 'حساب جديد',
    authName: 'الاسم', authPassword: 'كلمة المرور', authEmail: 'email@site.com',
    authSignupBtn: 'إنشاء الحساب', authWait: 'لحظة…',
    authPwHint: '8 أحرف على الأقل.',
